...
class DetectionMlflowModelDownload:
    def __init__(
        self,
        run: DetectionRun,
    ...
    @log_exceptions("[DETECTION_DOWNLOAD_CHAMPION_ERROR]")
    def download_champion_url(self, artifact_path: str) -> str:
        version = self._resolve_alias_version("champion")
        spec = TrackingArtifactDownloadSpec.for_detection(artifact_path)
    ...
    @log_exceptions("[DETECTION_DOWNLOAD_VERSION_ERROR]")
    ...
    @log_exceptions("[DETECTION_DOWNLOAD_CHAMPION_TO_FILE_ERROR]")
    ...
    @log_exceptions("[DETECTION_DOWNLOAD_VERSION_TO_FILE_ERROR]")
    ...
    @log_exceptions("[DETECTION_DOWNLOAD_RESOLVE_ALIAS_ERROR]")
...
# def build_use_case(repo_root: str | Path) -> DetectionMlflowModelDownload:
...
#     else:
#         if alias != "champion":
#             raise ValueError("Only alias='champion' is supported in detection main()")
#         if output_path is not None:
...
#     parser = argparse.ArgumentParser(description="Download detection artifacts from MLflow.")
#     parser.add_argument("--alias", default="champion")
#     parser.add_argument("--version")
#     parser.add_argument("--artifact-path", default="checkpoints/best.pt")
